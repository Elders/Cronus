    ...
    public class When_projection_state
    {
        Establish context = () =>
        {
            ...
            projectionHistory = Projection<ProjectionVersionsHandler>
                .FromHistory()
                .Event(new ProjectionVersionRequestedForReplay(id, new ProjectionVersion(projectionName, ProjectionStatus.Building, 1, hash), new VersionRequestTimebox(DateTime.Parse("2018-11-28T11:07:47.9657464Z"), DateTime.Parse("2018-11-29T11:07:47.9657464Z"))))
                .Event(new ProjectionVersionRequestedForReplay(id, new ProjectionVersion(projectionName, ProjectionStatus.Building, 2, hash), new VersionRequestTimebox(DateTime.Parse("2018-11-28T11:28:47.8453615Z"), DateTime.Parse("2018-11-29T11:28:47.8453615Z"))))
                .Event(new ProjectionVersionRequestedForReplay(id, new ProjectionVersion(projectionName, ProjectionStatus.Building, 3, hash), new VersionRequestTimebox(DateTime.Parse("2018-11-28T11:31:01.0982545Z"), DateTime.Parse("2018-11-29T11:31:01.0982545Z"))))
                .Event(new ProjectionVersionRequestedForReplay(id, new ProjectionVersion(projectionName, ProjectionStatus.Building, 4, hash), new VersionRequestTimebox(DateTime.Parse("2018-11-28T14:41:44.5082787Z"), DateTime.Parse("2018-11-29T14:41:44.5082787Z"))))
                .Event(new ProjectionVersionRequestedForReplay(id, new ProjectionVersion(projectionName, ProjectionStatus.Building, 5, hash), new VersionRequestTimebox(DateTime.Parse("2018-11-28T14:43:35.834907Z"), DateTime.Parse("2018-11-29T14:43:35.834907Z"))))
