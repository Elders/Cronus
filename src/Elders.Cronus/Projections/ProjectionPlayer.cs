...
//        public async Task<ReplayResult> RebuildAsync(ProjectionVersion version, DateTime rebuildUntil)
//        {
...
//                var allVersions = await GetAllVersionsAsync(version).ConfigureAwait(false);
...
//                                    await projectionWriter.SaveAsync(projectionType, theEvent, origin, version).ConfigureAwait(false);
//                                }
//                            }
//                        }
//                    }
...
//        async Task<ProjectionVersions> GetAllVersionsAsync(ProjectionVersion version)
//        {
...
//        async Task<bool> IsVersionTrackerMissingAsync()
//        {
