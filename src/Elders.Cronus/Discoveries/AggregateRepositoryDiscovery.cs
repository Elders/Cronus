...
namespace Elders.Cronus.Discoveries
{
    public class AggregateRepositoryDiscovery : DiscoveryBasedOnExecutingDirAssemblies<IAggregateRepository>
    {
        ...
        IEnumerable<DiscoveredModel> GetModels()
        {
            ...
            yield return new DiscoveredModel(typeof(IAggregateRepository), provider => new CronusAggregateRepository(provider.GetService<AggregateRepository>(), provider.GetService<IPublisher<IEvent>>()), ServiceLifetime.Transient);
        }
    }
}
