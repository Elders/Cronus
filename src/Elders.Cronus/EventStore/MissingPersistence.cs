...
internal sealed class MissingPersistence : IEventStoreFactory, IEventStore, IMessageCounter, IEventStorePlayer, IIndexStore
{
    ...
    public Task ApendAsync(IndexRecord indexRecord, CancellationToken cancellationToken = default) => throw new NotImplementedException(MissingPersistenceMessage);
    ...
    public Task DecrementAsync(Type messageType, long decrementWith = 1, CancellationToken cancellationToken = default) => throw new NotImplementedException(MissingPersistenceMessage);

    public Task DeleteAsync(IndexRecord indexRecord, CancellationToken cancellationToken = default) => throw new NotImplementedException(MissingPersistenceMessage);
    ...
    public IAsyncEnumerable<IndexRecord> GetAsync(string indexRecordId, CancellationToken cancellationToken = default) => throw new NotImplementedException(MissingPersistenceMessage);
    ...
    public Task<long> GetCountAsync(Type messageType, CancellationToken cancellationToken = default) => throw new NotImplementedException(MissingPersistenceMessage);

    public Task<long> GetCountAsync(string indexRecordId, CancellationToken cancellationToken = default) => throw new NotImplementedException(MissingPersistenceMessage);

    public IEventStore GetEventStore() => throw new System.NotImplementedException(MissingPersistenceMessage);

    public Task IncrementAsync(Type messageType, long incrementWith = 1, CancellationToken cancellationToken = default) => throw new NotImplementedException(MissingPersistenceMessage);
    ...
    public Task ResetAsync(Type messageType, CancellationToken cancellationToken = default) => throw new NotImplementedException(MissingPersistenceMessage);
}
