...
{
    public class RebuildNewIndex_EventToAggregateRootId_Job : CronusJob<RebuildIndex_JobData>
    {
        private readonly IEventStorePlayer eventStorePlayer;
        private readonly IEventStoreJobIndex index;

        public RebuildNewIndex_EventToAggregateRootId_Job(IEventStorePlayer eventStorePlayer, IEventStoreJobIndex index, ILogger<RebuildNewIndex_EventToAggregateRootId_Job> logger) : base(logger)
        {
