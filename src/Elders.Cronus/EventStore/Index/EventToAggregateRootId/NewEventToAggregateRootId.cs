...
namespace Elders.Cronus.EventStore.Index
{
    ...
    public class NewEventToAggregateRootId : ICronusEventStoreIndex, IEventStoreJobIndex
    {
        private readonly ILogger<NewEventToAggregateRootId> logger;

        private readonly IIndexStore indexStore;

        public NewEventToAggregateRootId()
        {

        }

        public NewEventToAggregateRootId(IIndexStore indexStore, ILogger<NewEventToAggregateRootId> logger)
        {
