...
namespace Elders.Cronus
{
    ...
    {
        private readonly ProjectionsStartup projectionsBoot;
        ...
        public CronusHost(ProjectionsStartup projectionsBoot, IConsumer<IApplicationService> appServices, IConsumer<IProjection> projections, IConsumer<IPort> ports, IConsumer<ISaga> sagas, IConsumer<IGateway> gateways, CronusHostOptions cronusHostOptions)
        {
