...
namespace Elders.Cronus.Pipeline.Config
{
    ...
    public class ProjectionConsumerSettings : PipelineConsumerSettings<IEvent>
    {
        ...
        public override void Build()
        {
            ...
            var builder = this as ISettingsBuilder;
            builder.Container.RegisterSingleton<IProjectionLoader>(() => new ProjectionRepository(builder.Container.Resolve<IProjectionStore>(builder.Name), builder.Container.Resolve<ISnapshotStore>(builder.Name), builder.Container.Resolve<ISnapshotStrategy>(builder.Name)), builder.Name);
            builder.Container.RegisterSingleton<IProjectionRepository>(() => new ProjectionRepository(builder.Container.Resolve<IProjectionStore>(builder.Name), builder.Container.Resolve<ISnapshotStore>(builder.Name), builder.Container.Resolve<ISnapshotStrategy>(builder.Name)), builder.Name);
        }
    }
