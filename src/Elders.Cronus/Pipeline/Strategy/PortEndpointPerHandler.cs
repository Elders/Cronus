...
//{
//    public class PortEndpointPerHandler : EndpointNameConventionWithCorrespondingErrorEndpoint
//    {
//        private IPipelineNameConvention pipelineNameConvention;

//        public PortEndpointPerHandler(IPipelineNameConvention pipelineNameConvention)
//        {
...
//                string endpointName = String.Format("{0}.Ports.{1}", boundedContext.BoundedContextNamespace, handlerType.Name);
