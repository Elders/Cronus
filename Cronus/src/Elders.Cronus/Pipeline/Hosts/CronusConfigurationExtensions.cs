...
namespace Elders.Cronus.Pipeline.Hosts
{
    public static class CronusConfigurationExtensions
    {
        ...
        public static CronusConfiguration ConfigureConsumer<T>(this CronusConfiguration config, string boundedContextName, Action<T> configuration) where T : IEndpointConsumerSetting<IMessage>
        {
